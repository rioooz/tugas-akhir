...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn { display: block; width: 100%; background: #9a2121ff; color: white; padding: 15px; border: none; border-radius: 8px; font-size: 1.1rem; font-weight: 600; cursor: pointer; text-align: center; text-decoration: none; transition: background 0.3s; margin-top: 20px; }
        .btn:hover { background: #ff7c01ff; }
