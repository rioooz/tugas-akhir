...
@section('content')
    ...
    <div class="form-card">
        <div class="form-header">
            <h3 class="form-title"><i class="fas fa-edit"></i> Edit Barang: {{ $product->name }}</h3>
        </div>
        ...
        <form action="{{ route('admin.daftar-barang.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            <div class="form-body">
                @csrf
                @method('PUT')
        ...
        <div class="delete-zone">
            ...
            <p>Menghapus produk akan menghilangkan semua data yang terkait dengan produk ini. Tindakan ini tidak dapat
                dibatalkan.</p>
            <form action="{{ route('admin.daftar-barang.destroy', $product->id) }}" method="POST" style="display: inline;"
